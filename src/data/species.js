...
export const species = {
  ...
  'sharks-rays': [
    ...
    { id: 'blacktip-reef-shark', common: 'Blacktip Reef Shark', scientific: 'Carcharhinus melanopterus', teaser: 'The quintessential shallow-reef shark, elegant and ever-present.', imageQuery: 'blacktip reef shark coral reef shallow' },
    ...
    { id: 'nurse-shark', common: 'Nurse Shark', scientific: 'Ginglymostoma cirratum', teaser: 'The ocean\'s most docile shark, often found napping in piles.', imageQuery: 'nurse shark resting reef bottom' },
  ],
  'marine-mammals': [
